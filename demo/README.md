# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="2aaf8-101">Exécution du projet terminé</span><span class="sxs-lookup"><span data-stu-id="2aaf8-101">How to run the completed project</span></span>
